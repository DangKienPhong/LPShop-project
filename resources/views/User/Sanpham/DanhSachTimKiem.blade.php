         ...
         <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
           <div class="aa-product-catg-content">
               ...
               <div class="aa-product-catg-head-left">
                 <form  class="aa-sort-form">
                   ...
                   <select name="sort" id="sort">
                     <option value="{{ Request::url()}}?sort_by=name" selected="Default">Default</option>
                     <option value="{{ Request::url()}}?sort_by=name">Name</option>
                     <option value="{{ Request::url()}}?sort_by=name">Price</option>
                     <option value="{{ Request::url()}}?sort_by=name">Date</option>
                   </select>
                 </form>
            ...
            @if($sanpham->TinhTrang==0)
                 ...
                 <div class="row">
                  <div class="col-lg-12 text-center">
                      <div class="breadcrumb__text">
                          ...
                          <h2 style="color:rgb(128, 19, 0);">Không tìm thấy sản phẩm trùng với các thông tin cần tìm!</h2>
                          <br>
                 ...
                 <li>
                   <figure>
                     <a class="aa-product-img" href="{{ url('chitietsanpham') }}"><img src="front_assets/img/women/girl-2.png" alt="polo shirt img"></a>

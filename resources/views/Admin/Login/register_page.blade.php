        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form method="POST" action="{{route('admin.luuAdmin')}}">
                        @csrf
                        @if (session('success'))
                            <div class="alerts">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                                                <h4 class="alert-heading"><span class="badge badge-pill badge-success">{{session('success')}} </span></h4> 
                                                <hr>
                                                <p class="mb-0">Hãy thử đăng nhập.</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" name="cpassword" placeholder="Comfirm Password" value="{{old('cpassword')}}">
                            <span style="color:red" class="help-block">
                                @error('cpassword')
                                    {{$message}}
                                @enderror

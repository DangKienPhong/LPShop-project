            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Bảng lọc người dùng</strong>
                    </div>
                    <div class="card-body card-block">
                        <form action="{{route('filterNguoiDung')}}" method="post" class="form-horizontal">
                            @csrf
                            
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tên người dùng</label></div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="name" placeholder="Nhập tên người dùng" class="form-control">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label class=" form-control-label">Tình trạng người dùng</label></div>
                                <div class="col col-md-9">
                                    <div class="form-check-inline form-check">
                                        <label for="inline-radio1" class="form-check-label ">
                                            <input type="radio" id="inline-radio1" name="isBan" value="1" class="form-check-input">Bị Khóa Tài Khoản
                                        </label>
                                        &nbsp;
                                        <label for="inline-radio2" class="form-check-label ">
                                            <input type="radio" id="inline-radio2" name="isBan" value="0" class="form-check-input" checked>Đang Hoạt Động
                                        </label>
                                        
                                    </div>
                                </div>
                            </div>
                            <button style="float: right;" type="submit" class="btn btn-primary"><i class="fa fa-check-circle"></i>&nbsp; Lọc người dùng</button>
                        </form>

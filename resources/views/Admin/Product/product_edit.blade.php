                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="{{route('showListSanPham')}}">Sản phẩm</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('updateSanPham', ['id'=>$SanPhamDuocChon->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                            {{ csrf_field() }}
                            @method('PUT')
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="id" placeholder="Nhập tên sản phẩm" class="form-control" value="{{$SanPhamDuocChon->id}}">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="TenSanPham" placeholder="Nhập tên sản phẩm" class="form-control" value="{{$SanPhamDuocChon->TenSanPham}}">
                                    <span style="color:red" class="help-block">
                                        @error('TenSanPham')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="date" id="text-input" name="NgayRaMat" placeholder="Nhập ngày ra mắt sản phẩm" class="form-control" value="{{$SanPhamDuocChon->NgayRaMat}}">
                                    <span style="color:red" class="help-block">
                                        @error('NgayRaMat')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="number" id="text-input" name="SoLuongTrongKho" placeholder="Nhập số lượng" class="form-control" value="{{$SanPhamDuocChon->SoLuongTrongKho}}">
                                    <span style="color:red" class="help-block">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="CPU" placeholder="Nhập tên CPU" class="form-control" value="{{$SanPhamDuocChon->CPU}}">
                                    <span style="color:red" class="help-block">
                                        @error('CPU')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="GPU" placeholder="Nhập tên GPU" class="form-control" value="{{$SanPhamDuocChon->GPU}}">
                                    <span style="color:red" class="help-block">
                                        @error('GPU')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="RAM" placeholder="Nhập tên RAM" class="form-control" value="{{$SanPhamDuocChon->RAM}}">
                                    <span style="color:red" class="help-block">
                                        @error('RAM')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="BoNhoTrong" placeholder="Nhập tên bộ nhớ trong" class="form-control" value="{{$SanPhamDuocChon->BoNhoTrong}}">
                                    <span style="color:red" class="help-block">
                                        @error('BoNhoTrong')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><textarea name="ChucNangHoTro" id="textarea-input" rows="9" placeholder="Nhập các chức năng" class="form-control">{{$SanPhamDuocChon->ChucNangHoTro}}</textarea>
                                    <span style="color:red" class="help-block">
                                        @error('ChucNangHoTro')
                                            {{$message}}
                                        @enderror
                                    ...
                                    <div class="form-check">
                                        <div class="checkbox">
                                            <label for="checkbox1" class="form-check-label ">
                                                <input type="checkbox" id="checkbox1" name="ThietBiBaoGom[]" value="Tay Cầm" class="form-check-input" @if (in_array('Tay Cầm', $listThietBi)) checked @endif>Tay Cầm
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label for="checkbox2" class="form-check-label ">
                                                <input type="checkbox" id="checkbox2" name="ThietBiBaoGom[]" value="Tai Nghe" class="form-check-input" @if (in_array('Tai Nghe', $listThietBi)) checked @endif> Tai nghe
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label for="checkbox3" class="form-check-label ">
                                                <input type="checkbox" id="checkbox3" name="ThietBiBaoGom[]" value="Doc sạc" class="form-check-input" @if (in_array('Doc sạc', $listThietBi)) checked @endif> Doc sạc
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label for="checkbox4" class="form-check-label ">
                                                <input type="checkbox" id="checkbox4" name="ThietBiBaoGom[]" value="Không có thiết bị" class="form-check-input" @if (in_array('Không có thiết bị', $listThietBi)) checked @endif> Không có thiết bị
                                            </label>
                                        </div>
                                        <span style="color:red" class="help-block">
                                            @error('ThietBiBaoGom')
                                ...
                                <div class="col col-md-9">
                                    <div class="form-check-inline form-check">
                                        <label for="inline-radio1" class="form-check-label ">
                                            <input type="radio" id="inline-radio1" name="HoTroBluetooth" value="Có" class="form-check-input" 
                                            @if ($SanPhamDuocChon->HoTroBluetooth == "Có") checked @endif>Hỗ trợ
                                        </label>
                                        &nbsp;
                                        <label for="inline-radio2" class="form-check-label ">
                                            <input type="radio" id="inline-radio2" name="HoTroBluetooth" value="Không" class="form-check-input"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col col-md-9">
                                    <div class="form-check-inline form-check">
                                        <label for="inline-radio1" class="form-check-label ">
                                            <input type="radio" id="inline-radio1" name="TinhTrang" value="1" class="form-check-input"
                                            @if ($SanPhamDuocChon->TinhTrang == 1) checked @endif>Sẵn sàng
                                        </label>
                                        &nbsp;
                                        <label for="inline-radio2" class="form-check-label ">
                                            <input type="radio" id="inline-radio2" name="TinhTrang" value="0" class="form-check-input"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="CongKetNoi" placeholder="Nhập tên cổng kết nối" class="form-control" value="{{$SanPhamDuocChon->CongKetNoi}}">
                                    <span style="color:red" class="help-block">
                                        @error('CongKetNoi')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="CongRaAV" placeholder="Nhập tên cổng ra av" class="form-control" value="{{$SanPhamDuocChon->CongRaAV}}">
                                    <span style="color:red" class="help-block">
                                        @error('CongRaAV')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="DonGia" placeholder="Nhập đơn giá của sản phẩm" class="form-control" value="{{$SanPhamDuocChon->DonGia}}">
                                    <span style="color:red" class="help-block">
                                        @error('DonGia')
                                            {{$message}}
                                        @enderror
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="file-multiple-input" class=" form-control-label">Cập Nhật hình ảnh</label></div>
                                <div class="col-12 col-md-9"><input type="file" id="file-multiple-input" name="hinhanh" accept="image/*" class="form-control-file"></div>
                            </div>
                            {{-- <div class="row form-group">
                                <div class="col col-md-3"><label for="file-multiple-input" class=" form-control-label">Thêm hình ảnh</label></div>
                                <div class="col-12 col-md-9"><input type="file" id="file-multiple-input" name="hinhanh[]" multiple="" class="form-control-file"></div>
                            </div> --}}
                            {{-- <div class="row form-group">

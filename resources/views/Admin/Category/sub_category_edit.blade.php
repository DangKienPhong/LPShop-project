                    ...
                    <div class="card-body card-block">
                        <form action="{{ route('chinhSuaDanhMuc', ['id'=>$DanhMucDuocChon->id]) }}" method="post" enctype="multipart/form-data" class="form-horizontal" >
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="TenDanhMuc" placeholder="Nhập tên danh mục" class="form-control" value="{{ $DanhMucDuocChon->TenDanhMuc }}">
                            ...
                            {{-- <button style="float: right;" type="button" class="btn btn-warning"><i class="fa fa-retweet"></i>&nbsp; Reset</button>
                            <button style="float: right;" type="button" class="btn btn-secondary"><i class="fa fa-mail-reply"></i>&nbsp; Trở về</button> --}}
                        </form>
                    </div>
